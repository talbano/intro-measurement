...
This chapter introduces two resources we'll be using throughout the book, the assessment development tools at [Proola.org](http://proola.org), and the statistical software R. The chapter ends with an introductory statistics review. The learning objectives focus on understanding statistical terms, and calculating and interpreting some introductory statistics.
...
* Full access to the site is currently limited to teachers participating in professional development and students taking courses in assessment and measurement.
...
The test development and item writing processes will be covered in detail in Chapter \@ref(development). For now, you should sign up for an account and become familiar with how the site is organized.
